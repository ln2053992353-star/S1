...
export class RecommendationReport {
  ...
  static _buildTitle(formatter) {
    ...
    var countText =
      formatter.iteration_count != null
        ? 'Iterations: ' + formatter.iteration_count
        : '';
  ...
  static _buildInfoGrid(formatter) {
    ...
    grid.appendChild(
      this._buildInfoCard(
        'Verification Score',
        formatter.verification_score != null
          ? String(formatter.verification_score)
          : 'N/A',
        'fas fa-check-circle',
        this._verificationColor(formatter.verification_score)
      )
    );
    grid.appendChild(
      this._buildInfoCard(
        'Iteration Count',
        formatter.iteration_count != null
          ? String(formatter.iteration_count)
          : '0',
        'fas fa-redo-alt',
        'text-teal-600'
      )
